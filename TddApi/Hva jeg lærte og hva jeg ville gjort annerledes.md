...
Jeg merket samtidig at Test Driven Development (TDD) var betydelig vanskeligere enn å skrive tester etterpå. Men jeg ser poenget med TDD, siden det bidrar til mer robust
kode og gir deg en sikkerhet mot at du ødelegger eksisterende funksjonalitet ved endringer senere i programutviklingen.
...
Jeg valgte å lage en annen type API enn en vanlig Todo API. Jeg lagde en API med Player XP og Monster.

Jeg lærte mye om hvordan man sender XP til serveren, og hvordan man setter opp modeller og tester for dette i en API.
...
- **pgAdmin:** Det å sette opp tilgang i API-et og koble det sammen med databasen ble mer obvious for meg, så jeg husker prosessen bedre nå.
...
api securitysetup.
Lerte at under appsettings.json så hadde jeg for kort secret på Jwt: Key: som gjorde at jeg fikk internal server error.
